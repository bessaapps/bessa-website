  ...
  return (
    <main>
      ...
      <div className={"max-w-5xl px-4 mx-auto"}>
        ...
        <div className={"max-w-5xl gap-4 my-24"}>
      ...
      <div className={"bg-base-content"}>
        <div
          className={
            "max-w-3xl flex flex-col items-center gap-4 px-4 py-24 mx-auto my-24"
          }
        >
          <blockquote
            cite={""}
          ...
          <div className={"grid grid-cols-1 sm:grid-cols-2 gap-4"}>
            <div>
              ...
              <p>
                ...
                mindset, the Bessa social feed delivers a vibrant timeline that
                is queer and deeply authentic.
              </p>
            </div>
            <div>
              <h2 className={"text-4xl font-medium mb-2"}>
            ...
            <div>
              ...
              <p>
                Bessa is officially breaking away from a superficial mindset.
                The member profiles are designed to celebrate the art of being
                us, giving you a digital canvas that is as vibrant and
      ...
      <div className={"bg-secondary"}>
        <div className={"max-w-5xl gap-4 px-4 py-24 mx-auto my-24"}>
