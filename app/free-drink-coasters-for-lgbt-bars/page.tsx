  ...
  return (
    <>
      <div className={"max-w-3xl flex flex-col gap-4 px-4 mx-auto my-24"}>
        ...
        <p>
          Hey there, fabulous venue owners and managers! At Bessa, we know that
          the absolute best nights out usually start with a fierce look, a
          strong cocktail, and an even stronger sense of community. As a
          creative hub for queer content and real connections, we are all about
          celebrating our diverse, found family. That&apos;s exactly why we are
          so thrilled to offer free drink coasters for LGBTQ bars! We want to
          help you keep your bar tops spotless while serving up a little extra
          flair for your patrons.
        </p>
        <p>
          Let&apos;s be real: your patrons deserve an atmosphere that is loud,
          proud, and right at home. Our custom-designed coasters aren&apos;t
          just practical pieces of cardboard; they are cheeky, fun conversation
          starters that reflect the beautiful diversity of our community. These
          coasters bring the playful Bessa vibe straight to your tables.
        </p>
        <Image
          src={Coasters}
          alt={
        ...
        <p>
          ...
          form below with your venue&apos;s details, and we&apos;ll ship a batch
          of Bessa magic right to your door. Let&apos;s make sure that wherever
          our community gathers, it&apos;s a place of creativity!
        </p>
        <div>
          <a
