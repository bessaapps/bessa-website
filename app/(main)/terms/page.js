...
export default function Terms() {
  return (
    <Container maxW={"container.xl"} py={16}>
      ...
      <Text mb={4}>
        Under no circumstances shall Bessa team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Bessa team or an
      ...
      <Text mb={4}>
        Bessa will not be responsible for any outcome that may occur during the
      ...
      <Text mb={4}>
        Bessa grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the app strictly in accordance with
        the terms of this Agreement.
      </Text>
      <Text mb={4}>
        These Terms & Conditions are a contract between you and Bessa (referred
        to in these Terms & Conditions as &quot;Bessa&quot;, &quot;us&quot;,
        &quot;we&quot; or &quot;our&quot;), the provider of the Bessa website
        and the services accessible from the Bessa website (which are
        collectively referred to in these Terms & Conditions as the &quot;Bessa
        Service&quot;).
      </Text>
      <Text mb={4}>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the Bessa Service.
      ...
      <UnorderedList mb={4}>
        ...
        <ListItem>
          Country: where Bessa or the owners/founders of Bessa are based, in
          this case is
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          Website: Bessa&apos;s site, which can be accessed via this URL:
        </ListItem>
        <ListItem>
      ...
      <Heading mb={4}>Restrictions</Heading>
      <Text mb={4}>You agree not to, and you will not permit others to:</Text>
      <UnorderedList mb={4}>
        <ListItem>
        ...
        <ListItem>
          ...
          of copyright or trademark) of Bessa or its affiliates, partners,
          suppliers or the licensors of the app.
        </ListItem>
      </UnorderedList>
      <Heading mb={4}>Return and Refund Policy</Heading>
      <Text mb={4}>
        Thanks for shopping at Bessa. We appreciate the fact that you like to
      ...
      <Text mb={4}>
        ...
        apply to transactions at Bessa. We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at Bessa, you agree to the terms along with Bessa&apos;s
        Privacy Policy.
      </Text>
      <Text mb={4}>
      ...
      <Heading mb={4}>Your Suggestions</Heading>
      <Text mb={4}>
        Any feedback, comments, ideas, improvements or suggestions
        (collectively, &quot;Suggestions&quot;) provided by you to Bessa with
        respect to the app shall remain the sole and exclusive property of
        Bessa.
      </Text>
      <Text mb={4}>
        Bessa shall be free to use, copy, modify, publish, or redistribute the
      ...
      <Heading mb={4}>Changes To Our Terms & Conditions</Heading>
      <Text mb={4}>
        You acknowledge and agree that Bessa may stop (permanently or
        ...
        specifically inform Bessa when you stop using the Service. You
        acknowledge and agree that if Bessa disables access to your account, you
      ...
      <Heading mb={4}>Modifications to Our app</Heading>
      <Text mb={4}>
        Bessa reserves the right to modify, suspend or discontinue, temporarily
        or permanently, the app or any service to which it connects, with or
        without notice and without liability to you.
      </Text>
      <Heading mb={4}>Updates to Our app</Heading>
      <Text mb={4}>
        Bessa may from time to time provide enhancements or improvements to the
      ...
      <Text mb={4}>
        ...
        the app. You agree that Bessa has no obligation to (i) provide any
      ...
      <Text mb={4}>
        ...
        or any other aspect thereof. Bessa does not assume and shall not have
      ...
      <Text mb={4}>
        ...
        Bessa, in the event that you fail to comply with any provision of this
      ...
      <Text mb={4}>
        Termination of this Agreement will not limit any of Bessa&apos;s rights
      ...
      <Heading mb={4}>Copyright Infringement Notice</Heading>
      <Text mb={4}>
      ...
      <Heading mb={4}>Indemnification</Heading>
      <Text mb={4}>
        You agree to indemnify and hold Bessa and its parents, subsidiaries,
      ...
      <Text mb={4}>
        ...
        respect to the app, including all implied warranties of merchantability,
        ...
        foregoing, Bessa provides no warranty or undertaking, and makes no
      ...
      <Text mb={4}>
        Without limiting the foregoing, neither Bessa nor any Bessa&apos;s
        ...
        content, or e-mails sent from or on behalf of Bessa are free of viruses,
      ...
      <Heading mb={4}>Limitation of Liability</Heading>
      <Text mb={4}>
        Notwithstanding any damages that you might incur, the entire liability
        of Bessa and any of its suppliers under any provision of this Agreement
      ...
      <Text mb={4}>
        ...
        Bessa or its suppliers be liable for any special, incidental, indirect,
        ...
        Bessa or any supplier has been advised of the possibility of such
      ...
      <Heading mb={4}>Severability</Heading>
      <Text mb={4}>
      ...
      <Text mb={4}>
        ...
        notices published by Bessa on the Services, shall constitute the entire
        agreement between you and Bessa concerning the Services. If any
        ...
        term, and Bessa&apos;s failure to assert any right or provision under
        this Agreement shall not constitute a waiver of such right or provision.
        YOU AND Bessa AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED
      ...
      <Heading mb={4}>Amendments to this Agreement</Heading>
      <Text mb={4}>
        Bessa reserves the right, at its sole discretion, to modify or replace
      ...
      <Text mb={4}>
        ...
        agree to the new terms, you are no longer authorized to use Bessa.
      </Text>
      <Heading mb={4}>Entire Agreement</Heading>
      <Text mb={4}>
        The Agreement constitutes the entire agreement between you and Bessa
        regarding your use of the app and supersedes all prior and
        contemporaneous written or oral agreements between you and Bessa.
      </Text>
      <Text mb={4}>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Bessa&apos;s services, which Bessa will
        provide to you at the time of such use or purchase.
      </Text>
      <Heading mb={4}>Updates to Our Terms</Heading>
      <Text mb={4}>
      ...
      <Heading mb={4}>Intellectual Property</Heading>
      <Text mb={4}>
        ...
        owned by Bessa, its licensors or other providers of such material and
        are protected by and international copyright, trademark, patent, trade
        ...
        written permission of Bessa, unless and except as is expressly provided
        in these Terms & Conditions. Any unauthorized use of the material is
        prohibited.
      </Text>
      <Heading mb={4}>Agreement to Arbitrate</Heading>
      <Text mb={4}>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Bessa&apos;s INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Bessa concerning the Services or this
      ...
      <Heading mb={4}>Notice of Dispute</Heading>
      <Text mb={4}>
        In the event of a dispute, you or Bessa must give the other a Notice of
        ...
        Dispute via email to: topher@getbessa.com. Bessa will send any Notice of
        Dispute to you by mail to your address if we have it, or otherwise to
        your email address. You and Bessa will attempt to resolve any dispute
        through informal negotiation within sixty (60) days from the date the
        Notice of Dispute is sent. After sixty (60) days, you or Bessa may
        commence arbitration.
      </Text>
      <Heading mb={4}>Binding Arbitration</Heading>
      <Text mb={4}>
        If you and Bessa don’t resolve any dispute by informal negotiation, any
      ...
      <Heading mb={4}>Submissions and Privacy</Heading>
      <Text mb={4}>
        ...
        and will become the sole property of Bessa without any compensation or
        credit to you whatsoever. Bessa and its affiliates shall have no
      ...
      <Heading mb={4}>Promotions</Heading>
      <Text mb={4}>
        Bessa may, from time to time, include contests, promotions, sweepstakes,
      ...
      <Heading mb={4}>Typographical Errors</Heading>
      <Text mb={4}>
      ...
      <Heading mb={4}>Miscellaneous</Heading>
      <Text mb={4}>
        ...
        of Bessa. Bessa will be entitled to injunctive or other equitable relief
        (without the obligations of posting any bond or surety) in the event of
        any breach or anticipatory breach by you. Bessa operates and controls
        the Bessa Service from its offices in . The Service is not intended for
        distribution to or use by any person or entity in any jurisdiction or
        country where such distribution or use would be contrary to law or
        regulation. Accordingly, those persons who choose to access the Bessa
        ...
        incorporate the Bessa Privacy Policy) contains the entire understanding,
        and supersedes all prior understandings, between you and Bessa
      ...
      <Text mb={4}>
        Bessa is not responsible for any content, code or any other imprecision.
      </Text>
      <Text mb={4}>Bessa does not provide warranties or guarantees.</Text>
      <Text mb={4}>
        In no event shall Bessa be liable for any special, direct, indirect,
      ...
      <Text mb={4}>
        The Bessa Service and its contents are provided &quot;as is&quot; and
        &quot;as available&quot; without any warranty or representations of any
        kind, whether express or implied. Bessa is a distributor and not a
        publisher of the content supplied by third parties; as such, Bessa
        ...
        accessible via the Bessa Service. Without limiting the foregoing, Bessa
        specifically disclaims all warranties and representations in any content
        transmitted on or in connection with the Bessa Service or on sites that
        may appear as links on the Bessa Service, or in the products provided as
        a part of, or otherwise in connection with, the Bessa Service, including
        without limitation any warranties of merchantability, fitness for a
        particular purpose or non-infringement of third party rights. No oral
        advice or written information given by Bessa or any of its affiliates,
        ...
        without notice. Without limiting the foregoing, Bessa does not warrant
        that the Bessa Service will be uninterrupted, uncorrupted, timely, or
        error-free.
      </Text>
