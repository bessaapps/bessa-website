    ...
    <>
      <Section>
        ...
        <div className={"flex flex-col gap-4"}>
          ...
          <h2 className={"text-secondary text-3xl font-medium mt-4"}>
            What is Bessa?
          </h2>
          <p>
            ...
            events, friends, or just a space where you feel seen, Bessa helps
            you find your people and stay connected.
          </p>
          <h2 className={"text-secondary text-3xl font-medium mt-4"}>
            Who can join Bessa?
          </h2>
          <p>
            Bessa is designed for everyone under the LGBTQ umbrella. While
            allies are welcome to support the project, the app itself is built
            to serve LGBTQ users who want space to connect, share experiences,
            and find each other outside of hookup culture.
          </p>
          <h2 className={"text-secondary text-3xl font-medium mt-4"}>
          ...
          <p>
            Yes! Bessa is available on both iOS and Android. Just search for it
            in the{" "}
            <Link
              href={iOSLink}
              target={"_blank"}
          ...
          <p>
            ...
            connection. Sponsorships include perks like a custom badge and
            public recognition.
          </p>
        </div>
      </Section>
