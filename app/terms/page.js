...
export const metadata = {
  title:
    "Terms and Conditions | Bessa LGBTQIA+ Community App | Safe Inclusive Body-Positive LGBTQIA+ Community"
};
  ...
  return (
    <Container maxW={"100%"} py={16}>
      ...
      <ul>
        ...
        <li>Website: Bessa&apos;s site, which can be accessed via this URL:</li>
        <li>
      ...
      <p>
        ...
        <a
          ...
          data-cfemail="ddbfb8aeaebcbcadad9dbab0bcb4b1f3beb2b0"
        >
          [email&#160;protected]
        </a>
        . Bessa will send any Notice of Dispute to you by mail to your address
        if we have it, or otherwise to your email address. You and Bessa will
        ...
        days, you or Bessa may commence arbitration.
      </p>
      ...
      <p>Bessa does not provide warranties or guarantees.</p>
      <p>
